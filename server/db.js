...
export async function connect(){
    db.connect(function(err) {
        ...
        multiQuery(
            ...
            'CREATE TABLE IF NOT EXISTS Users(ine VARCHAR(11) NOT NULL UNIQUE,nom_prenom VARCHAR(256) NOT NULL, classe VARCHAR(10) NOT NULL, etablissement VARCHAR(256) NOT NULL, photo VARCHAR(2048) DEFAULT "https://i.imgur.com/tbvsqWK.png",tel VARCHAR(15) DEFAULT NULL,email VARCHAR(320) DEFAULT NULL,PRIMARY KEY (ine));',
